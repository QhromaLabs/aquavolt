...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _loadProfile() async {
    ...
    try {
      ...
      // Check if we have profile data in 'profiles' table (same table for landlords/tenants usually)
  ...
  Future<void> _saveProfile() async {
    ...
    try {
      await Supabase.instance.client.from('profiles').upsert({
        ...
        'phone': phone,
        'phone_number': phone,
        'role': 'landlord', // Ensure role is preserved or set
      ...
      if (mounted) {
        showTopToast(context, 'Update failed: $e', type: ToastType.error);
      }
    } finally {
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  _nameController.text.isEmpty ? 'Landlord' : _nameController.text,
                      ...
                      child: Column(
                        children: [
                          ...
                          _ProfileItem(
                            ...
                            title: 'Notifications',
                            onTap: () => showTopToast(context, 'Coming Soon', type: ToastType.info),
                          ),
                          const Divider(height: 1),
                          _ProfileItem(
